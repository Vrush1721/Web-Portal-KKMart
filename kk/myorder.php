...
<div style="overflow-x:auto;">
  <button class="bs" class="bs"><a href="delivaredorder.php">Delivered Order</a></button>
  <br><br>
  <table>
  <tr>
         <th id="poid">oid</th>
  ...
  <?php
      ...
      $res = mysqli_query($cann,"select * from orders  where email='$_SESSION[email]' && status='pending' ");
      $i=0;
        ...
        <td><?php echo $row['paymod']; ?></td>
         <td><?php echo $row['status']; ?></td>
          ...
          <td class="delete"><center>
                  ...
                  <a href="usercanorder.php?orid=<?php echo $row['orid']; ?>"  style="..."><i class="fa fa-trash" style="color: black;"></i>Cancel</a>
        </center></td>

...
<body  >
    ...
    <?php
                ...
                $query = "SELECT * FROM product where ctid=2 ";
...
<div class="pp"> 
     <h1 style="text-align: center; word-spacing: 10px; letter-spacing: 4px; font-size:50px;">Species And Masalas</h1>
    ...
    <br>
      ...
      <h2 name="pname"><?php echo $row["pname"]; ?> </h2>  
        <p style="font-size:16px;"><?php echo $row["pdescrip"]; ?></p>
                        ...
                        <input type="number" name="quantity" value="1" class="form-control" ><br><br></b>
                          <input type="submit" name="add_to_cart"  class="btn btn-success" style="background-color: orange; width: 200px;height: 30px;border-radius: 13px;font-size: 20px;" value="Add to Cart" >
